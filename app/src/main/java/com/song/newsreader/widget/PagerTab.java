...
import com.song.newsreader.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
	...
	private int mDividerColor = Color.parseColor("#ffffff");//分割线颜色
